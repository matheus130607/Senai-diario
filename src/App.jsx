...
=======
  return renderWithVLibras(
      <div className="app-shell min-h-screen font-sans text-zinc-900">
>>>>>>> d194492 (test-design)
        {/* Modal Confirm */}
        {confirmModal.isOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-zinc-950/45 p-4 backdrop-blur-sm">
            <div className="ds-panel max-w-sm w-full p-6 animate-in fade-in-0 slide-in-from-bottom-2 duration-200">
      ...
      {/* Toast */}
      {toast && (
        <div className="fixed bottom-4 right-4 z-50 flex items-center gap-3 rounded-lg border border-zinc-800 bg-zinc-950 px-5 py-3 text-white shadow-sm animate-in fade-in-0 slide-in-from-bottom-2 duration-200">
      ...
      {/* Navbar Superior */}
      <nav className="sticky top-0 z-10 border-b border-zinc-200 bg-white/95 backdrop-blur-xl">
        <div className="w-full px-0">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4 pl-4 sm:pl-6 lg:pl-8">
              <button onClick={toggleSidebar} className="rounded-md p-2 text-zinc-500 transition-colors duration-150 hover:bg-zinc-100 hover:text-zinc-950" aria-label="Abrir ou esconder menu lateral">
              ...
              <div className="hidden md:flex h-6 w-px bg-zinc-200"></div>
            ...
            <div className="flex items-center gap-4 pr-4 sm:pr-6 lg:pr-8">
              <div className="flex items-center gap-2 rounded-full border border-zinc-200 bg-white px-3 py-1.5 text-xs font-medium">
                ...
                {currentUser.role === 'professor' && <User className="w-3.5 h-3.5 text-zinc-600" />}
                {currentUser.role === 'empresa' && <Building className="w-3.5 h-3.5 text-zinc-600" />}
              ...
              <div ref={accountMenuRef} className="relative">
                ...
                {accountMenuOpen && (
                  <div className="account-menu absolute right-0 top-full z-50 mt-2 w-56 overflow-hidden rounded-lg border border-zinc-200 bg-white py-1 shadow-sm">
                    <button
                      type="button"
